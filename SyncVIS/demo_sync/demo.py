...
from syncvis import add_syncvis_config
from predictor import VisualizationDemo


# constants
WINDOW_NAME = "syncvis video demo"
...
def get_parser():
    parser = argparse.ArgumentParser(description="syncvis demo for builtin configs")
    parser.add_argument(
        "--config-file",
        default="configs/youtubevis_2019/syncvis_R50_bs8.yaml",
        metavar="FILE",
