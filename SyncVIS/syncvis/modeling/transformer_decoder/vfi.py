...
class syncvis(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.syncvis_mask_features = Conv2d(
            conv_dim,
            mask_dim,
            kernel_size=1,
            stride=1,
        ...
        weight_init.c2_xavier_fill(self.syncvis_mask_features)
    ...
    def from_config(cls, cfg, in_channels):
        ...
        ret["hidden_dim"] = cfg.MODEL.syncvis.HIDDEN_DIM
        ret["num_frame_queries"] = cfg.MODEL.MASK_FORMER.NUM_OBJECT_QUERIES
        ret["num_queries"] = cfg.MODEL.syncvis.NUM_OBJECT_QUERIES
        # Transformer parameters:
        ret["nheads"] = cfg.MODEL.syncvis.NHEADS
        ret["dim_feedforward"] = cfg.MODEL.syncvis.DIM_FEEDFORWARD

        assert cfg.MODEL.syncvis.DEC_LAYERS >= 1
        ret["enc_layers"] = cfg.MODEL.syncvis.ENC_LAYERS
        ret["dec_layers"] = cfg.MODEL.syncvis.DEC_LAYERS
        ret["enc_window_size"] = cfg.MODEL.syncvis.ENC_WINDOW_SIZE
        ret["pre_norm"] = cfg.MODEL.syncvis.PRE_NORM
        ret["enforce_input_project"] = cfg.MODEL.syncvis.ENFORCE_INPUT_PROJ

        ret["num_classes"] = cfg.MODEL.SEM_SEG_HEAD.NUM_CLASSES
        ret["num_frames"] = cfg.INPUT.SAMPLING_FRAME_NUM
        ret["clip_last_layer_num"] = cfg.MODEL.syncvis.LAST_LAYER_NUM

        ret["conv_dim"] = cfg.MODEL.SEM_SEG_HEAD.CONVS_DIM
        ret["mask_dim"] = cfg.MODEL.SEM_SEG_HEAD.MASK_DIM
        ret["sim_use_clip"] = cfg.MODEL.syncvis.SIM_USE_CLIP
        ret["use_sim"] = cfg.MODEL.syncvis.SIM_WEIGHT > 0.0
