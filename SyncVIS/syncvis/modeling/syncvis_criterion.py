...
class syncvisSetCriterion(nn.Module):
    ...
    def loss_labels(self, outputs, targets, indices, num_masks):
        ...
        losses = {'loss_syncvis_ce': loss_ce}
    ...
    def loss_masks(self, outputs, targets, indices, num_masks):
        ...
        losses = {
            "loss_syncvis_mask": sigmoid_ce_loss_jit(point_logits, point_labels, num_masks),
            "loss_syncvis_dice": dice_loss_jit(point_logits, point_labels, num_masks),
        }
    ...
    def get_loss(
        ...
        loss_map = {
            'syncvis_labels': self.loss_labels,
            'syncvis_masks': self.loss_masks,
